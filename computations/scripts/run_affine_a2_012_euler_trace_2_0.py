...
def _wrapper_module_name(realization_name: RealizationName) -> str:
    return {
        "geometric": "computations.scripts.run_affine_a2_geometric_012_euler_trace_2_0",
        "geometric_3d": "computations.scripts.run_affine_a2_geometric_3d_012_euler_trace_2_0",
        "kac_moody_6d": "computations.scripts.run_affine_a2_kac_moody_6d_012_euler_trace_2_0",
    }[realization_name]
