"""Run the affine A2 Euler-trace computation in the faithful 3D realization."""
...
DEFAULT_OUTPUT = Path(
    "computations/euler_trace_outputs/affine_a2_faithful_euler_trace_output.txt"
)
...
def main() -> int:
    ...
    try:
        _run(logger, started, timeout_seconds=args.timeout_seconds)
        return 0
...
def _run(logger: Logger, started: float, *, timeout_seconds: int) -> None:
    logger.log("Affine A2 faithful 3D Euler-trace computation")
